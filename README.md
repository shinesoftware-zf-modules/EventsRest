# Event Rest
This module helps to insert, delete, and read all events information by a RESTFUL service
...
* [Events Module](https://github.com/shinesoftware-zf-modules/Events)
...
```json
    [
        {
            "type": "vcs",
            "url": "https://github.com/shinesoftware-zf-modules/EventsRest"
        }
    ],
```
